      ...
      theory: [
        {
          ...
          text:
            ...
            'дуже часто винен DNS — старий запис, забутий CNAME або кеш.',
        },
        {
          kind: 'table',
      ...
      theory: [
        ...
        },
        {
          ...
          rows: [
            ...
            [
              '404',
              'такого шляху немає — або помилковий URL, або зламаний роут',
            ],
            ['502', 'проксі не достукався до бекенда — бекенд лежить'],
            [
              '503',
              'сервіс тимчасово недоступний: перевантажений або на обслуговуванні',
            ],
