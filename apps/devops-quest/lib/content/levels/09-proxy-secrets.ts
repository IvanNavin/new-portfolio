      ...
      theory: [
        {
          kind: 'text',
          text:
            'У nginx **кожна директива** закінчується крапкою з комою, а блоки — фігурними ' +
            'дужками. Забута `;` — найчастіша поломка, і вона валить увесь сервер, а не один сайт.',
        },
        {
          kind: 'table',
          rows: [
      ...
      theory: [
        {
          kind: 'text',
          text:
            'Принцип 12-factor: **конфіг живе в оточенні**, не в коді. Один і той самий образ ' +
            'їде і на staging, і в прод — відрізняються лише змінні. Це те, що робить ' +
            'реліз повторюваним.',
        },
        {
          kind: 'code',
