        ...
        options: [
          {
            id: 'a',
            label:
              'Підняти SLO до 99.99%, щоб бюджет помилок став більшим і релізи не спинялись',
          },
          {
            id: 'b',
            label:
          ...
          },
          {
            id: 'c',
            label:
              'Вимкнути алерти до кінця місяця — вони шумлять і заважають команді працювати над фічами',
          },
          {
            id: 'd',
            label:
              'Нічого не робити: бюджет усе одно обнулиться першого числа наступного місяця',
          },
        ],
        correct: ['b'],
        explain:
