      ...
      theory: [
        {
          kind: 'text',
          text:
            'Docker працює як демон від root, а спілкуються з ним через сокет ' +
            '`/var/run/docker.sock`. Свіжий користувач до нього доступу не має — звідси ' +
        ...
        },
        {
          ...
          rows: [
            ...
            ['docker logs x', 'що контейнер написав у stdout'],
          ],
        },
        {
          kind: 'note',
      ...
      theory: [
        {
          kind: 'text',
          text:
            'Dockerfile — це рецепт образу. Кожна інструкція створює **шар**, і Docker кешує шари: ' +
            'якщо інструкція та її входи не змінились, шар береться з кешу.',
        },
        {
          kind: 'table',
          rows: [
...

    {
      ...
      theory: [
        ...
        },
        {
          kind: 'text',
          text:
            'У `-p 8080:3000` перше число — порт **хоста**, друге — порт **усередині контейнера**. ' +
      ...
      theory: [
        {
          ...
          text:
            ...
            '`docker compose` описує їх усі в одному YAML і піднімає однією командою, ' +
