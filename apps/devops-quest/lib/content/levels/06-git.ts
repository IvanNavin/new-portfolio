      ...
      theory: [
        {
          kind: 'text',
          text:
            'У git три «місця», де живуть зміни: **робочий каталог** (файли, які ти правиш), ' +
            '**індекс** (те, що ти відібрав для коміту) і **історія** (зафіксовані коміти).',
        },
        {
          kind: 'table',
          rows: [
...

    {
      ...
      theory: [
        ...
        },
        {
          kind: 'text',
          text:
            'Після додавання файлу в `.gitignore` він перестає зʼявлятись у `git status` як ' +
            'untracked. Перевірити просто: `git status` більше про нього не згадує.',
        },
        {
          kind: 'note',
          text:
      ...
      theory: [
        {
          kind: 'text',
          text:
            'Гілка — це рухома закладка на коміт. Робота у фіча-гілці означає, що `main` ' +
            'лишається робочим, поки ти щось ламаєш у себе.',
        },
        {
          kind: 'table',
          rows: [
