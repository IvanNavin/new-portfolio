      ...
      theory: [
        {
          kind: 'text',
          text:
            'У Linux ти завжди хтось конкретний. `whoami` каже імʼя, `id` — числовий uid, ' +
            'основну групу і всі додаткові. Групи вирішують, до чого ти маєш доступ.',
        },
        {
          kind: 'table',
          rows: [
      ...
      theory: [
        {
          kind: 'text',
          text:
            'Права читаються трьома трійками: **власник**, **група**, **інші**. ' +
            'У кожній трійці — `r` (4), `w` (2), `x` (1). Сума дає цифру.',
        },
        {
          kind: 'table',
      ...
      theory: [
        ...
        },
        {
          ...
          rows: [
            ...
            ['useradd -m -s /bin/bash ci', 'ще й задати оболонку'],
