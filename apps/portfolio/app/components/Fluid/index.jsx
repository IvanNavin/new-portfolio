...
export const Fluid = () => {
  ...
  useEffect(() => {
    ...
    function createProgram(vertexShader, fragmentShader) {
      ...
      if (!gl.getProgramParameter(program, gl.LINK_STATUS))
        window?.console.trace(gl.getProgramInfoLog(program));
    ...
    function compileShader(type, source, keywords) {
      ...
      if (!gl.getShaderParameter(shader, gl.COMPILE_STATUS))
        window?.console.trace(gl.getShaderInfoLog(shader));
  ...
  `,
    ...
    const ditheringTexture = createTextureAsync(LDR);
  ...
  return <canvas ref={canvasRef} id='fluid' />;
};
