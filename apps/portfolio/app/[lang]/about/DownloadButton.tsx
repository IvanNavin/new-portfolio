...
export const DownloadButton = () => {
  return (
    <Link
      ...
      className={clsxm(
        'download text-gold relative inline-block cursor-pointer overflow-hidden bg-transparent px-6 py-7 text-2xl',
        'uppercase tracking-wider transition-transform duration-200 ease-linear hover:rotate-2 active:rotate-3',
        'origin-top-left',
      )}
    >
